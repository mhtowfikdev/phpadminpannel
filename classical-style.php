...
require_once( __DIR__ . '/../../dev-control.php' );
 ...
 $bg_primary = 'linear-gradient( ' . _COLOR_PRIMARY_ . ', ' . _COLOR_GRADIENT_END_ . ' );';
   $bg_top = 'linear-gradient( ' . _COLOR_PRIMARY_ . ', ' . _COLOR_GRADIENT_END_ . ' );';
...
?>
*{ margin:0 ;padding=0;}
.bg-primary { background: <?= $bg_primary ?> !important; }
.bg-main { background: <?= $bg_primary ?> !important; }
.profile { 
      background-image: <?= $bg_primary ?> !important;   
