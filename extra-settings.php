	    ...
	    <section>
				<div class="mx-1 col-sm">
					...
					<section class="row">
						...
						<div class="form-group col-sm">
						    	<label>Claim Toast</label>
						<input name="click_toast" value="<?= $click_toast ?? '' ?>" type="text" class="form-control" required>
							
						</div>

						<div class="form-group col-sm">
						    	<label>Success Toast</label>
						<input name="success_toast" value="<?= $success_toast ?? '' ?>" type="text" class="form-control" required>
							
						</div>

						<div class="form-group col-sm">
						    	<label>View Toast</label>
						<input name="view_toast" value="<?= $view_toast ?? '' ?>" type="text" class="form-control" required>
