	    ...
	    <section>
				...
				<div class="mx-1 col-sm">
					...
					<?php }?>
						...
						<h4 class="py-2"><i>style</i>App Theme</h4>
						<div class="form-group col-sm">
						<label>Choose App Theme</label>
						<select name="app_theme" class="form-control">
						<option value="<?= $app_theme ?? '' ?>" hidden><?= $app_theme ?? '' ?></option>
							<option value="Modern">Modern</option>
					  	        <option value="Modern_Pro">Modern_Pro</option>
							<option value="Classic">Classic</option>
							<option value="Classic_Pro">Classic_Pro</option>
							<option value="Elegant">Elegant</option>
							<option value="Elegant_Pro">Elegant_Pro</option>
						</select>
					   </div>
				...
				<h4 class="py-2"><i>settings</i>Withdraw Settings</h4>
					...
					<section class="row">
						...
						<h4 class="py-2"><i>how_to_reg</i>Registration Settings</h4>
					<section class="row">
						<div class="form-group col-sm">
						...
						<section class="row">
						<div class="form-group col-sm">
							<label>Login on Registration Device</label>
							<select name="reg_login" class="form-control">
								<?php
									$option = ( $reg_login == 1 ) ? 'Yes' : 'No';
								?>
								<option value="<?= $reg_login ?? '' ?>" hidden><?= $option ?></option>
								<option value="1">Yes</option>
								<option value="0">No</option>
							</select>
						</div>
					...
					<h4 class="py-2"><i>history</i>Version Control</h4>
					    <section class="row">
					<div class="form-group col-sm">
