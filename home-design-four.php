...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
	...
	<style>
		...
		<?php include 'css/elegant-style.php' ?>
		#htw button {
		    border: none;
	        font-weight: bold;
	        border-radius: 5px;
       ...
       <section class="profile" id="userData">
           <div class="user-block">
               ...
               <div class="userinfo">
                   ...
                   <h4><font style="font-family: 'Material Icons';">payments</font>BDT:- <?= $user_data['balance'] ?? '1000' ;?></h4>
               </div>
           </div>
       </section>
       ...
       <section class="block-main">
           ...
           <div class="line1">
               ...
               <div onclick="Android.openWebActivity('Profile', 'profile')" class="item">
                   <i class="material-icons icons">person</i> <br>
                   Profile
               </div>
               
                <div id="d_succes" class="item">
             
                   <i class="material-icons icons">emoji_events</i> <br>
                   Daily Bonus
               </div>
           ...
           <center>
            <div class="line1">
               ...
               <div onclick="location.href='<?= $htw_link ?? '#'?>'" class="item">
                 <?php endif ?>
                   <i class="material-icons icons">play_circle_filled</i> <br>
                   How to Work
               </div>
               <div type="button" data-toggle="modal" data-target="#myModal" class="item">
                   <i class="material-icons icons">notifications</i> <br>
                   Notice
               </div>
               <div onclick="location.href='<?= $support_group ?>'" class="item">
                   <i class="material-icons icons">support</i> <br>
                   Support
               </div>
           </div></center>
       </section>
