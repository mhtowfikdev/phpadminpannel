       ...
       <section class="block-main">
           ...
           <div class="line1">
               ...
               <div id="vpn" onclick="Android.taskActivity()" class="item">
                   <img src="https://i.postimg.cc/9QCnzqHm/images-1-1.png" height="80px" width="80px"/> <br>
               ...
               <div onclick="Android.openWebActivity('Profile', 'profile')" class="item">
                   <img src="https://invisiblelabbd.com/images/avatar.png" height="80px" width="80px"/> <br>
                   Profile
               </div>
               
                <div id="d_succes" class="item">
             
                   <img src="https://i.postimg.cc/8sgG3kYy/images-10.jpg" height="80px" width="80px"/> <br>
                   Daily Bonus
               </div>
            ...
            <div class="line1">
               <div onclick="Android.openWebActivity('Leaderboard', 'leaderboard')" class="item">
                   <img src="https://i.postimg.cc/8s8xZyYM/received-477266427331086.jpg" height="80px" width="80px"/> <br>
                   Leaderboard
               </div>
               <div onclick="Android.openWebActivity('Wallet', 'wallet')" class="item">
                  <img src="https://i.postimg.cc/4xgMZGpK/images-1.jpg" height="80px" width="80px"/> <br>
                   Withdraw
               </div>
               <div onclick="Android.openWebActivity('Payment History', 'payments')" class="item">
                   <img src="https://i.postimg.cc/RF8XQXpm/images-1-3.png" height="80px" width="80px"/> <br>
                   History
               </div>
           </div></center>
           <center>
            <div class="line1">
               ...
               <div onclick="location.href='<?= $htw_link ?? '#'?>'" class="item">
                 <?php endif ?>
                   <img src="https://i.postimg.cc/j562gP0g/images-2.jpg" height="80px" width="80px"/> <br>
                   How to Work
               </div>
               <div type="button" data-toggle="modal" data-target="#myModal" class="item">
                   <img src="https://i.postimg.cc/Bn2fsRkP/images-removebg-preview.png" height="80px" width="80px"/> Notice 
               </div>
               <div onclick="location.href='<?= $support_group ?>'" class="item">
                   <img src="https://i.postimg.cc/pTkCN9KC/images-4.jpg" height="80px" width="80px"/> <br>
                   Support
               </div>
           </div></center>
       </section>
